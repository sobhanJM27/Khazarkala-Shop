    ...
    <main className='flex flex-col gap-10 px-12 py-6'>
      <section className='flex flex-col gap-4'>
        ...
        <p className={cn(textBody1Bold)}>
          ...
          باکیفیت ایرانی است. این سایت با گردآوری مجموعه‌ای متنوع از کالاها، از
          جمله مواد غذایی، لوازم خانگی، پوشاک، لوازم دیجیتال و محصولات دیگر،
          تلاش می‌کند کیفیت، اصالت و رضایت مشتری را به صورت مستقیم و بدون واسطه
          به دست مصرف‌کنندگان برساند. خزر کالا با همکاری نزدیک با تولیدکنندگان و
          تأمین‌کنندگان معتبر، انجام کنترل‌های کیفی دقیق و ارائه خدمات ارسال
          سریع، بستری امن و مطمئن برای خرید آنلاین فراهم کرده است تا خانواده‌ها
          بتوانند با اطمینان کامل، انتخابی سالم، اصیل و باکیفیت داشته باشند.
        </p>
      </section>
